...
@implementation JSChatCellViewModel

-(void)calculateElementCoordinateWithContentHandler:(JSMessageContentHandler*)handler{
    ...
    CGSize contentSize = [handler calculateContentSize];
    
    if (_message.from == UUMessageFromMe) {
        contentX = iconX - contentSize.width - ChatContentLeft - ChatContentRight - ChatMargin;
    }
    
    _contentF = CGRectMake(contentX, contentY, contentSize.width + ChatContentLeft + ChatContentRight,
